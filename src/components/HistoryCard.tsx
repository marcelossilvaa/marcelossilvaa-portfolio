          ...
          >
            <article className="futuristic-card futuristic-card-purple rounded-2xl p-4 md:p-5 border-l-2 border-l-accent-primary/70">
              <div className="grid grid-cols-1 md:grid-cols-[170px_1fr] gap-4 md:gap-5 items-start">
                <div className="flex items-center justify-center bg-white/80 dark:bg-slate-900/45 border border-border-soft min-h-[110px] rounded-xl p-2">
                  <Image src={item.image} alt={item.institution} className="w-[120px] max-md:w-[100px]" />
                </div>
