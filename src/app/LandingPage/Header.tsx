...
export default function Header() {
  ...
  return (
    <header className="z-10 flex justify-center w-full fixed backdrop-blur-md bg-opacity-50 bg-white">
      <div className="flex h-[7vh] justify-between items-center text-[15px] text-black-100 max-w-6xl w-[95%]">
        <Link href={'/#banner'} style={{ scrollMarginTop: '8vh' }} className="flex flex-row gap-1 items-center z-10">
